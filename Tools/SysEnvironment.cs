...
namespace ConEnv.Tools
{
    public class SysEnvironment
    {
        public static void SubPath(string strHome)
        {
            string pathlist,pathlistNew = "";
            ...
            if (isPathExist)
            {
                SetSysEnvironment("PATH", pathlistNew);

            }
        }

        public static void AddPath(string strHome)
        {
        ...
        /// <param name="name"></param>
        /// <returns></returns>
        private bool CheckSysEnvironmentExist(string name)
        {
        ...
        private static void SetPathAfter(string strHome)
        {
            string pathlist;
            pathlist = GetSysEnvironmentByName("PATH");
            //检测是否以;结尾
